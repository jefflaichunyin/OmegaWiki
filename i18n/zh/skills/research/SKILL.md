...
- 使用 question 工具提示用户选择一个 idea（或输入 stop 停止）
...
- 展示 idea 状态摘要：
  ...
  ```
- 使用 question 工具提示用户确认：ready for paper / need more experiments / stop here
